              ...
              <div class="card-body">
                ...
                <form id="login-form" action="{{ route('login.in') }}" method="POST">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input class="form-control" name="email" type="email" placeholder="yourmail@example.com">
                  </div>
