...
from widgets.tk_filedialog.tk_filedialog_view import FileDialogView
...
if __name__ == "__main__":
    ...
    main_view = FileDialogView(500, 350)

    # Inyectamos la raíz en nuestra clase
    app = MainWindow(root, "GUI TKinter - Uso messagebox & filedialog", main_view)
